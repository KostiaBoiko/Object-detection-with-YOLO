...
while True:
    ...
    imgGraphics = cv2.imread("miata.png", cv2.IMREAD_UNCHANGED)
    img = cvzone.overlayPNG(img, imgGraphics, (823, 0))
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if currentClass == "car" or currentClass == "bus" or currentClass == "truck " \
                ...
                curentArray = np.array([x1, y1, x2, y2, conf])
                detections = np.vstack((detections, curentArray))
    ...
    for result in resultsTracker:
        ...
        cx, cy = x1 + w//2, y1+h//2  # calculate center points
        ...
        cv2.putText(img, str(len(totalCount)), (970, 100), cv2.FONT_HERSHEY_PLAIN, 5, (50, 50, 255), 8)
